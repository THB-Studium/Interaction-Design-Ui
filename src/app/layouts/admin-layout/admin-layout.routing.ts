...
export const AdminLayoutRoutes: Routes = [
  ...
  { path: "startpage", component: HomeComponent, canActivate: [AuthorizationGuard] },
  ...
  { path: "tripoffer/view/:landId", component: LearnMoreComponent, canActivate: [AuthorizationGuard] },
